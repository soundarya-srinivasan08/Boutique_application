...
@Component({
  selector: 'app-bridalwear',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './bridalwear.component.html',
  styleUrl: './bridalwear.component.css'
})
export class BridalwearComponent {

  // Declare minPrice and maxPrice
